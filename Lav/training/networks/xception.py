...
from components.f3_head import FAD_Head
...
class Xception(nn.Module):
    ...
    def __init__(self, xception_config):
        ...
        self.srm_conv = SRMConv2d_simple(inc=3, learnable=xception_config["srm_learnable"])
        self.FAD_Head = FAD_Head(size=299)
