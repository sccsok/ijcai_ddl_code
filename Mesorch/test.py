...
from IMDLBenCo.IMDLBenCo.datasets import ManiDataset, JsonDataset
from IMDLBenCo.IMDLBenCo.transforms import get_albu_transforms
from IMDLBenCo.IMDLBenCo.evaluation import PixelF1, ImageF1
...
def get_args_parser():
    ...
    parser.add_argument('--save_dir', type=str, default='./results', help='Path to save predictions')
